...
class MemberController extends Controller
{
    ...
    public function getBookings(){
        ...
        $bookings = BookingTour::with('user')->with('location')->with('package')->where([['booking_date','<=',now()],['user_id','=',$id]])->get();
    ...
    public function upcomingTours(){
        ...
        $upcommings =  B BookingTour::with('user')->with('location')->with('package')->where([['booking_date','<=',now()],['user_id','=',$id],['booking_status','=',3]])->get();
