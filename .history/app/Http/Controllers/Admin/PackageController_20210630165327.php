...
class PackageController extends Controller
{
    ...
    public function update(Request $request){
        ...
        if ($request->hasfile('image')) {
            ...
            $package->thumbnail = $request->oldimage;
        }
    ...
    public function delete($id){
        ...
        $package = Package::with('locations')->where('id',$id)->first();
        if(BookingTour::where('package_id',$package->id)->first() != null){

            return response()->json('You Can Not Delete This Package. Because This Package Is Booked By A Member');
