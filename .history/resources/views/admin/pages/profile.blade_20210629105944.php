...
<div class="container-fluid">
    ...
    <div class="form-group">
        ...
        <input type="password" name="password-confirmation" class="form-control" value="Admin" placeholder="Confirm New Password" >
        </div>
    </div>
    <div class="form-group">
        <label>Update Image</label>
        <input type="file" class="form-control" value="Admin" placeholder="Confirm New Password" >
        </div>
    </div>
    <div class="form-group">
