...
<div class="container-fluid">
    ...
    <input type="email" class="form-control" value="{{$user->email}}" placeholder="Confirm New Password" >
    </div>
    <div class="form-group">
        <label>Role</label>
        <input type="password" class="form-control" value="Admin" placeholder="Confirm New Password" >
        </div>
    </div>
    </div>
