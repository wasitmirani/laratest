 ...
 <div class="col-lg-8 col-md-12">
   ...
   <form>
    <div class="form-group">
        ...
        <button type="button" class="btn btn-round btn-primary" id="changePassword">Update</button> &nbsp;&nbsp;
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <form>
            <div class="form-group">
                <input type="file" class="form-control" placeholder="Current Password">
                </div>

                </div>
                </div>
                <button type="button" class="btn btn-round btn-primary" id="changeLogo">Update</button> &nbsp;&nbsp;
