    ...
    <div class="container">
        ...
        @foreach($packages as $package)
            <div class="col-lg-4"  style="padding-top: 10px;">
                <div class="box">
                    <div class="img-box"><img src="{{asset('/admin/img/package/'.$package->thumbnail)}}" class="img-fluid" alt=""><h3>{{$package->name}}</h3></div>
...
<div class="row">
    <div class="col-4"></div>
    {{-- <div class="col-4">{{$packages->links('pagination::bootstrap-4')}}</div> --}}
    <div class="col-4"></div>
    </div>
