<div class="tab-pane fade active show" id="user-list" role="tabpanel">
    ...
    <td>
          ...
          <li>
            ...
            <ul>
            <li><a type="button" class="update_status" data-id="{{$booking->id}}" data-status="3">Dashboard</a></li>
            <li><a type="button" class="update_status"  data-id="{{$booking->id}}" data-status="1">Project list</a></li>
            <li><a type="button" class="update_status" data-id="{{$booking->id}}" data-status="2">Taskboard</a></li>
