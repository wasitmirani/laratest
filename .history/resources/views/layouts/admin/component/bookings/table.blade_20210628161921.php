            ...
            <td>
                ...
                <ul class="metismenu">
                  <li>
                    ...
                    <ul>
                    <li><a type="button" class="update_status btn btn-primary" data-id="{{$booking->id}}" data-status="3">Approve</a></li>
                    <li><a type="button" class="update_status btn btn-secondary"  data-id="{{$booking->id}}" data-status="1">Pending</a></li>
                    <li><a type="button" class="update_status btn btn-danger" data-id="{{$booking->id}}" data-status="2">Reject</a></li>
