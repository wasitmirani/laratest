<div class="tab-pane fade active show" id="user-add" role="tabpanel">
  ...
  <select>
      ...
      <option @if ($booking->status == 1) selected @endif value="">Pending</option>
      <option @if ($booking->status == 2) selected @endif  value="">Approve</option>
      <option @if ($booking->status == 2) selected @endif  value="3">Reject</option>
  </select>
    </div>
    </div>
    <div class="col-12">
