<div id="header_top" class="header_top">
    ...
    <div class="theme_div">
        ...
        <a href="../dark/index.html"><img src="{{asset('assets/images/themes/dark.png')}}" class="img-fluid"></a>
        </li>
        <li class="list-group-item mb-2">
        <p>RTL Version</p>
        <a href="../rtl/index.html"><img src="{{asset('assets/images/themes/rtl.png')}}" class="img-fluid"></a>
        </li>
        <li class="list-group-item mb-2">
        <p>Theme Version2</p>
        <a href="index.html"><img src="{{asset('assets/images/themes/theme2.png')}}" class="img-fluid"></a>
        </li>
        <li class="list-group-item mb-2">
        <p>Theme Version3</p>
        <a href="../theme3/index.html"><img src="{{asset('assets/images/themes/theme3.png')}}" class="img-fluid"></a>
        </li>
        <li class="list-group-item mb-2">
        <p>Theme Version4</p>
        ...
        <a href="../horizontal/index.html"><img src="{{asset('assets/images/themes/horizontal.png')}}" class="img-fluid"></a>
        </li>
        </ul>
        </div>
        </div>
        ...
        <div class="user_div">
            <h5 class="brand-name mb-4">MAUI Admin</h5><a href="javascript:void(0)" class="user_btn"><i class="icon-logout"></i></a></h5>
            <div class="card">
            <div class="card-body">
            <div class="media">
