    ...
    <li>
        <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="icon-rocket"></i><span>Users</span></a>
         <ul>
            ...
            <li><a href="{{route('admin.users')}}"><span>Add Users</span></a></li>
       </ul>
  </li>
  <li>
    <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="icon-rocket"></i><span>Bookings</span></a>
     <ul>
        ...
        <li><a href="{{route('admin.bookings')}}"><span>Add Bookings</span></a></li>
   </ul>
</li>
<li>
    <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="icon-rocket"></i><span>Bookings</span></a>
     <ul>
        ...
        <li><a href="{{route('admin.locations')}}"><span>Add Locations</span></a></li>
   </ul>
</li>
