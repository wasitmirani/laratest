<div id="left-sidebar" class="sidebar ">
  ...
  <li>
    <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="icon-calender"></i><span>Bookings</span></a>
     <ul>
...
<li>
    <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="icon-locations"></i><span>Locations</span></a>
     <ul>
