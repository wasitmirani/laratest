...
<td>
    ...
    <ul class="metismenu">
      <li>
        ...
        <ul>
        <li><button type="button" class="update_role" data-id="{{$user->id}}" data-status="2">Admin</button></li>
        <li><button type="button" class="update_role"  data-id="{{$user->id}}" data-status="1">Member</button></li>
