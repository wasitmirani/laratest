...
<td>
    ...
    <ul class="metismenu">
      <li>
        ...
        <ul>
            <li><button type="button" class="update_role btn btn-primary"  data-id="{{$user->id}}" data-role="1">Member</button></li>
        <li><button type="button" class="update_role btn btn-primary" data-id="{{$user->id}}" data-role="2">Admin</button></li>
