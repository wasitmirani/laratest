...
<td>
    ...
    <ul class="metismenu">
      <li>
        ...
        <ul>
        <li><a type="button" class="update_status" data-id="{{$user->id}}" data-status="2">Admin</a></li>
        <li><a type="button" class="update_status"  data-id="{{$user->id}}" data-status="1">Member</a></li>
