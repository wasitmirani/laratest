...
<td>
    ...
    <ul class="metismenu">
      <li>
        ...
        <ul>
            <li><a type="button" class="update_role btn btn-primary"  data-id="{{$user->id}}" data-role="1">Member</a></li>
        <li><a type="button" class="update_role btn btn-primary" data-id="{{$user->id}}" data-role="2">Admin</a></li>
