...
Route::middleware(['auth'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/locations',[App\Http\Controllers\Admin\LocationsController::class,'index'])->name('locations');
        Route::get('/locations/create',[App\Http\Controllers\Admin\LocationsController::class,'create'])->name('locations.create');
        Route::post('/locations',[App\Http\Controllers\Admin\LocationsController::class,'store'])->name('locations.store');
        Route::post('/locations/delete/{id}',[App\Http\Controllers\Admin\LocationsController::class,'delete'])->name('locations.delete');
        Route::get('/locations/edit/{id}',[App\Http\Controllers\Admin\LocationsController::class,'edit'])->name('locations.edit');
        Route::post('/locations/update/{id}',[App\Http\Controllers\Admin\LocationsController::class,'update'])->name('locations.update');
