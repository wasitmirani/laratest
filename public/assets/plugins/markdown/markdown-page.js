require(['markdown','jquery','to_markdown','bootstrap_markdown'],function(markdown,$){$(function(){var initContent='<h4>Hello there</h4> '+
...
'<p>Click "List"</p> Enjoy!';$('#markdown-editor').text(toMarkdown(initContent));});});